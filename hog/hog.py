...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for num_rolls in range (1, 11):
        ...
        average = find_average(num_rolls, dice)
        roll_averages.append(average)
        
    for num_rolls in range (1, 11):
        if roll_averages[num_rolls - 1] == max(roll_averages):
            return num_rolls
    # END PROBLEM 8
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if 100 - score < 15:
        return 3
    if (opponent_score / 2) - score < 7 and opponent_score > 60:
        return -1
    if (score + opponent_score) % 7 == 0:
        return 5
    if (score + opponent_score) % 7 < 10:
        return 5
    if (score / 2) - opponent_score < 7 and score > 60:
        return 8
